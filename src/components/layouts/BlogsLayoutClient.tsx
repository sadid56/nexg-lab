...
const BlogsLayoutClient = ({ children }: { children: ReactNode }) => {
  const { isZenMode, isRightSidebarHidden } = useConfigStore();
        ...
        {!hideSidebar && (
          <div className='hidden lg:block max-w-[25%] border-l-2 dark:border-hidden border-gray-200 relative'>
            <div className='sticky top-0 h-screen'>
              <div className='absolute dark:block hidden left-0 top-0 h-full w-[2px] bg-linear-to-b from-transparent via-theme-primary/20 dark:via-theme-primary/30 to-transparent' />
...
export default BlogsLayoutClient;
