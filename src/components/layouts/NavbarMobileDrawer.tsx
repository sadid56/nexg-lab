...
import { Clock, Hash, Layout, LogOut, Menu, Search, SlidersHorizontal } from "lucide-react";
  ...
  return (
    <div className='flex lg:hidden items-center gap-2'>
      ...
      <Button
        ...
        className='transition-transform duration-300 hover:scale-110 text-theme-primary'
      >
        ...
        <Drawer.Portal>
          ...
          >
            ...
            <div className='p-4 bg-white dark:bg-gray-950 rounded-t-[10px] flex-1 overflow-y-auto'>
              ...
              {recentBlogs && recentBlogs.length > 0 && (
                <div className='mb-6'>
                  <div className='flex items-center gap-2 mb-3'>
                    <div className='p-1.5 rounded-lg bg-linear-to-br from-theme-primary to-theme-secondary'>
                  ...
                  <div className='space-y-2'>
                    {recentBlogs.slice(0, 5).map((post) => (
                      <Link
                        ...
                        className='group flex items-start gap-3 p-3 rounded-xl hover:bg-theme-primary/10 transition-all duration-200 border border-transparent hover:border-theme-primary/20 dark:hover:border-gray-800'
                      >
                        <div className='flex-1 min-w-0'>
                          <span className='text-sm font-medium leading-tight text-gray-800 dark:text-gray-200 group-hover:text-theme-primary transition-colors block'>
                            {post.title}
                          </span>
                          {post.readTime && (
              ...
              <div className='h-px bg-linear-to-r from-transparent via-theme-primary/20 to-transparent mb-6' />
                ...
                <div className='mb-6'>
                  <div className='flex items-center justify-between mb-3'>
                    <div className='flex items-center gap-2'>
                      <div className='p-1.5 rounded-lg bg-linear-to-br from-theme-secondary to-theme-primary'>
                    ...
                    {searchParams.size !== 0 && (
                      <Button
                        ...
                        className='bg-linear-to-r from-theme-primary to-theme-secondary text-white shadow-lg hover:shadow-xl transition-all duration-300'
                        size={"sm"}
                      >
                        Clear
                      </Button>
                  ...
                  <div className='flex flex-wrap gap-2'>
                    {keywords.map((tag) => (
                      <Button
                        ...
                        className={cn(
                          `inline-flex items-center rounded-full bg-gray-100 dark:bg-neutral-800 px-3 py-1 text-xs font-medium text-gray-600 hover:text-theme-primary hover:bg-theme-primary/10 dark:hover:bg-neutral-700 transition-colors`,
                          tag.slug === category ? "text-theme-primary bg-theme-primary/10" : "dark:text-gray-300",
                        )}
                      >
                        {tag.title}
                      </Button>
